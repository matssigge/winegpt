...
test("users can create an entry and see it in history", async ({ page }) => {
  ...
  await page.getByRole("button", { name: "No occasions yet" }).click()
  await expect(page.getByText("1 of 3 wines")).toBeVisible()
  await expect(page.getByRole("heading", { name: "Lopez de Heredia Tondonia", exact: true })).toBeVisible()
  await page.getByRole("button", { name: "With occasions" }).click()
  await expect(page.getByText("2 of 3 wines")).toBeVisible()
